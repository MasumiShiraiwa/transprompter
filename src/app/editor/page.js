...
export default function Editor({project_id, project_name, performers_list }) {
    ...
    // const performers_list_a = performers.map(item => item.name);
    // console.log("performers_list_a", performers_list_a, typeof performers_list_a);

    return (
        <div>
            <Layout project_id={project_id} project_name={project_name} performers_list_props={performers_list} />
        </div>
    )
}